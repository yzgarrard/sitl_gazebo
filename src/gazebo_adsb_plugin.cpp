...
namespace gazebo {
GZ_REGISTER_MODEL_PLUGIN(AdsbPlugin)

AdsbPlugin::AdsbPlugin() : ModelPlugin()
{ }
...
void AdsbPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
...
std::pair<double, double> AdsbPlugin::reproject(ignition::math::Vector3d& pos)
{
